...
class Search {
  ...
  getResults() {
    axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(`${siteData.root_url}/wp-json/mamiejacquotte/v1/search?term=${this.searchField.value}`).then(response => {
      const results = response.data;
      this.resultsDiv.innerHTML = `
          <div class="row">
            <div class="one-third">
              <h2 class="search-overlay__section-title">Résultats des recettes</h2>
              ${results.generalInfo.length ? '<ul class="link-list min-list">' : '<p>Aucune recette correspondante !</p>'}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkmimach_plugin"] = globalThis["webpackChunkmimach_plugin"] || [];
